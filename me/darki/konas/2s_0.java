 ...
 * Renamed from me.darki.konas.2s
 * Duplicate member names - consider using --renamedupmembers true
 */
public class 2s_0
extends 2r_0 {
    public 2E c;
    public ArrayList<2r_0> c = new ArrayList();
    ...
    public void 1(int n2, int n3, int n4) {
        block0: {
            ...
            this.0().forEach(arg_0 -> 2s_0.c(n2, n3, n4, arg_0));
        }
    }
    ...
    public void c(char c2, int n2) {
        block0: {
            super.c(c2, n2);
            if (!this.7()) break block0;
            this.0().forEach(arg_0 -> 2s_0.c(c2, n2, arg_0));
        }
    }
    ...
    public boolean 0(int n2, int n3, int n4) {
        super.0(n2, n3, n4);
        boolean bl = 2s_0.c(n2, n3, this.e(), this.6(), this.d(), this.9());
        if (bl) {
            switch (n4) {
                case 0: {
                    this.1().8();
    ...
    public 2s_0(2E e2, float f2, float f3, float f4, float f5, float f6, float f7) {
        super(e2.0(), f2, f3, f4, f5, f6, f7);
        this.c = e2;
    }
    ...
    public void c(int n2, int n3, float f2) {
        block2: {
            ...
            int n5 = n4 = this.c.6() ? ((89)3H.2.6()).c() : ((89)3H.4.6()).c();
            if (((Boolean)3H.9.6()).booleanValue() && 2s_0.c(n2, n3, this.e(), this.6(), this.d(), this.9())) {
                n4 = this.c.6() ? ((89)3H.2.6()).4().brighter().hashCode() : new Color(96, 96, 96, 100).hashCode();
            }
            94.c(this.e(), this.6(), this.d(), this.9(), n4);
            9b.c(this.8(), (int)(this.e() + 4.0f), (int)(this.6() + this.9() / 2.0f - 9b.c(this.8()) / 2.0f - 0.5f), ((89)3H.3.6()).c());
            if (!this.7()) break block2;
            this.0().forEach(arg_0 -> 2s_0.c(n2, n3, f2, arg_0));
        }
    }
    ...
    public void 4() {
        super.4();
        float f2 = this.9();
        for (8h_0 h_02 : 2F.c(this.1())) {
            float f3;
            float f4 = h_02.3() ? 5.0f : 1.0f;
            float f5 = f3 = h_02.3() ? 6.0f : 2.0f;
            if (h_02.6() instanceof Boolean) {
                this.c().add(new 2p_0(h_02, this.e(), this.6(), f4, f2, this.d() - f3, 12.0f));
                f2 += 12.0f;
                continue;
            }
            if (h_02.6() instanceof 8f_0) {
                this.c().add(new 2v_0(h_02, this.e(), this.6(), f4, f2, this.d() - f3, 12.0f));
                f2 += 12.0f;
                continue;
            }
            if (h_02.6() instanceof Number) {
                this.c().add(new 2w_0(h_02, this.e(), this.6(), f4, f2, this.d() - f3, 12.0f));
                f2 += 12.0f;
                continue;
            }
            if (h_02.6() instanceof Enum) {
                this.c().add(new 2t_0(h_02, this.e(), this.6(), f4, f2, this.d() - f3, 12.0f));
                f2 += 12.0f;
                continue;
            }
            if (!(h_02.6() instanceof 89)) continue;
            this.c().add(new 2q_0(h_02, this.e(), this.6(), f4, f2, this.d() - f3, 60.0f));
            f2 += 12.0f;
        }
    ...
    public void c(int n2, int n3, int n4, long l2) {
        block0: {
            super.c(n2, n3, n4, l2);
            if (!this.7()) break block0;
            this.0().forEach(arg_0 -> 2s_0.c(n2, n3, n4, l2, arg_0));
        }
    }

...
extends 2E {
    ...
    public static int c(NonNullList nonNullList) {
        return nonNullList.stream().filter(33::c).mapToInt(ItemStack::func_190916_E).sum();
    }
    ...
    public void 5() {
        super.5();
        int n2 = ((IInventoryPlayer)33.c.player.inventory).getAllInventories().stream().mapToInt(33::c).sum();
        String string = n2 + " Totems";
